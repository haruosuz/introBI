...
- [バイオインフォマティクスデータスキル ――オープンソースツールを使ったロバストで再現性のある研究](https://www.oreilly.co.jp/books/9784873118635/)
  ...
  - [第1刷正誤表](https://www.oreilly.co.jp/books/9784873118635/#errata0)
...
- 
- 2021-10-05 No. 1 - イントロダクション [Introduction](#introduction)
  - 2021-10-11 23:59 課題1提出期限 Deadline for [assignment 1](https://github.com/haruosuz/introBI/blob/master/2021/CaseStudy.md#assignment-1)
- 2021-10-12 No. 2 - バイオインフォマティクス・プロジェクトの管理 [Managing Bioinformatics Projects](#managing-bioinformatics-projects)
  - 2021-10-18 23:59 課題2提出期限 Deadline for [assignment 2](https://github.com/haruosuz/introBI/blob/master/2021/CaseStudy.md#assignment-2)
- 2021-10-19 No. 3 - Unixシェル [Unix Shell](#unix-shell)
  - 2021-10-25 23:59 課題3提出期限 Deadline for [assignment 3](https://github.com/haruosuz/introBI/blob/master/2021/CaseStudy.md#assignment-3)
- 2021-10-26 No. 4 - バイオインフォマティクス・データ [Bioinformatics Data](#bioinformatics-data)
  - 2021-11-01 23:59 課題4提出期限 Deadline for [assignment 4](https://github.com/haruosuz/introBI/blob/master/2021/CaseStudy.md#assignment-4)
- 2021-11-02 No. 5 - シェルスクリプト [Shell Scripting](#shell-scripting)
  - 2021-11-08 23:59 課題5提出期限 Deadline for [assignment 5](https://github.com/haruosuz/introBI/blob/master/2021/CaseStudy.md#assignment-5)
- 2021-11-09 No. 6 - [NCBI Genome List](https://github.com/haruosuz/introBI/blob/master/2020/CaseStudy.md#ncbi-genome-list)
  - 2021-11-15 23:59 課題6提出期限 Deadline for [assignment 6](https://github.com/haruosuz/introBI/blob/master/2021/CaseStudy.md#assignment-6)
- 2021-11-16 No. 7 - 中間発表 [Interim report](#interim-report)
  - 2021-11-22 23:59 課題7提出期限 Deadline for [assignment 7](https://github.com/haruosuz/introBI/blob/master/2021/CaseStudy.md#assignment-7)
...
- 2021-12-14 No. 10 - [Guest Speaker](#guest-speaker)
- 2021-12-21 No. 11 - Unixデータツール [Unix Data Tools](#unix-data-tools)
  - 2022-01-10 23:59 課題11提出期限 Deadline for [assignment 11](https://github.com/haruosuz/introBI/blob/master/2021/CaseStudy.md#assignment-11)
- 事務室閉室 Office closed （12/28～1/5）
- 2022-01-11 No. 12 - Case Study: Reproducibly Analyzing Data
  - [my_project](#my_project)
  - R言語 [R Language](#r-language)
  - 2022-01-17 23:59 課題12提出期限 Deadline for [assignment 12](https://github.com/haruosuz/introBI/blob/master/2021/CaseStudy.md#assignment-12)
- 2022-01-18 No. 13 No. 13 - 最終回 final class
  - 最終発表 [final presentation](#final-presentation)
  - 2022-01-25 23:59 課題13提出期限 Deadline for [assignment 13](https://github.com/haruosuz/introBI/blob/master/2021/CaseStudy.md#assignment-13)
...
- プログラミングならドットインストール
  - PREMIUM [UNIXコマンド入門 (全28回)](https://dotinstall.com/lessons/basic_unix_v3)
  - PREMIUM [シェルスクリプト入門 (全17回)](https://dotinstall.com/lessons/basic_shellscript_v2)
  - [マークダウン記法入門 (全10回)](https://dotinstall.com/lessons/basic_markdown_v3)
...
「アプリケーション」フォルダ内の「ユーティリティ」フォルダの中に「[ターミナル](https://techacademy.jp/magazine/5155)」があるので、ダブルクリックで開く。
...
> ###### What's in a Name?  
> Do not use spaces (` `) in file and directory names. Use only letters, numbers (`{A..Z}{a..z}{0..9}`), underscores (`_`), and dashes (`-`) in file and directory names. Including extensions in filenames helps indicate the type of each file. (e.g., `README_2021-10-12.md`).  
> ファイル（ディレクトリ）名には、[スペース](https://ja.wikipedia.org/wiki/スペース)(` `)を使わない。英数字(`{A..Z}{a..z}{0..9}`)かアンダースコア(`_`)かダッシュ(`-`)を使う。ファイル名に拡張子を付けることでファイルの種類を示す。（例. `README_2021-10-12.md`）  
...
Figure 2-1. [HTML Rendering](https://github.com/vsbuffalo/bds-files/blob/master/chapter-02-bioinformatics-projects/notebook.md) of the [Markdown notebook](https://raw.githubusercontent.com/vsbuffalo/bds-files/master/chapter-02-bioinformatics-projects/notebook.md)  
...
- [Introduction to Unix - Bioinformatics Workbook](https://bioinformaticsworkbook.org/Appendix/Unix/unix-basics-1.html)
- [Unix CheatSheet - Bioinformatics Workbook](https://bioinformaticsworkbook.org/Appendix/Unix/UnixCheatSheet.html)
- [UNIXのコマンド集](http://crusade1096.web.fc2.com/unix.html)
...
- https://twitter.com/StevenXGe/status/1459209095991500804
...
### my_project
  ...
  - 2020 [my_project](https://github.com/haruosuz/introBI/blob/master/2020/README.md#my_project)
  - 2019-10-01 [UniProtKB/Swiss-Prot project](https://github.com/haruosuz/introBI/tree/master/2019/my_project)
  - 2018-11-27 [GTF/GFF](https://github.com/haruosuz/introBI/blob/master/2018/CaseStudy.md#2018-11-27)
  - 2018-10-28 [NCBI ASSEMBLY_REPORTS Project](https://github.com/haruosuz/ncbi/tree/master/assembly_reports)
  - 2015 [examples](https://github.com/haruosuz/introBI/blob/master/2018/README.md#project-directory-examples)
...
プロジェクト・ディレクトリの圧縮ファイル (*my_project.zip*) を取得し展開する:  
```
# Download the compressed file of the project directory
wget https://github.com/haruosuz/introBI/raw/master/2021/my_project.zip
...
# run the script:
bash scripts/run_all.sh 2>&1 | tee log.$(date +%F).txt
