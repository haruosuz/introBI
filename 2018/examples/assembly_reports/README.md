...
Let's run the shell script for inspecting metadata with:

    bash scripts/run_inspecting_assembly_summary.sh 2> stderr.txt > analysis/output_inspecting_assembly_summary.txt
