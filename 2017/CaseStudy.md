...
### Website
[National Center for Biotechnology Information](http://www.ncbi.nlm.nih.gov)右下 NCBI FTP Site を開き、<ftp://ftp.ncbi.nlm.nih.gov/genomes/GENOME_REPORTS/> に移動する。例えば、*README*をクリックして開く。
